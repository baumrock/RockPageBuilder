...
document.addEventListener('DOMContentLoaded', function () {
  ...
  console.log("UIkit found - using extended RockMatrix features :)");
  let util = uk.util;

  let sortable = uk.sortable('.rmx-sortable');
  util.on(document, 'moved', '.rmx-sortable', function(e) {
    ...
    let blockid = util.data(alfred, 'rmxblock');
